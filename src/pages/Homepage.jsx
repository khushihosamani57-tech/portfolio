                ...
                <footer className="py-8 px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24">
                    <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="flex items-center">
                            <GitHubButton className="self-center" href="https://github.com/khushihosamani57-tech" data-color-scheme={theme} data-icon="octicon-star" data-size="large" data-show-count="False" aria-label="Star dsbalico/dsfolio on GitHub">Github</GitHubButton>
                        </div>
